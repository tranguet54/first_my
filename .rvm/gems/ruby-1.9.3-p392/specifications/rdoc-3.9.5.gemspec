...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CVE-2013-0256.rdoc", "History.txt", "LICENSE.txt", "Manifest.txt", "README.txt", "RI.txt", "bin/rdoc", "Rakefile"]
  s.files = ["bin/rdoc", "bin/ri", "CVE-2013-0256.rdoc", "History.txt", "LICENSE.txt", "Manifest.txt", "README.txt", "RI.txt", "Rakefile"]
