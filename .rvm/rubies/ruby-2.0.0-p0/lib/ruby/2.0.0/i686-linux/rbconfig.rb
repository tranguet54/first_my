...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/ilu/.rvm/rubies/ruby-2.0.0-p0")
  ...
  CONFIG["configure_args"] = " '--disable-install-doc' '--prefix=/home/ilu/.rvm/rubies/ruby-2.0.0-p0' '--with-opt-dir=/home/ilu/.rvm/usr' '--enable-shared'"
  ...
  CONFIG["rubyw_install_name"] = ""
  CONFIG["LIBRUBY_DLDFLAGS"] = "-Wl,-soname,lib$(RUBY_SO_NAME).so.$(MAJOR).$(MINOR) -L/home/ilu/.rvm/usr/lib  -Wl,-R/home/ilu/.rvm/usr/lib "
  ...
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " -I/home/ilu/.rvm/usr/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -fstack-protector -rdynamic -Wl,-export-dynamic -L/home/ilu/.rvm/usr/lib  -Wl,-R/home/ilu/.rvm/usr/lib "
